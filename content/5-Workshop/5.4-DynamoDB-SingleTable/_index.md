...
![Amazon DynamoDB Console Dashboard](/images/5-Workshop/5.4-S3-onprem/access_amazon_dynamodb1.png)
...
![Check On-Demand Capacity Mode](/images/5-Workshop/5.4-S3-onprem/check_capacity_mode1.png)

   * **Encryption:** `KMS` (encrypted using Customer Managed Key `DataKMSKey`).
   * **Point-in-time recovery (PITR):** `ENABLED`.

![Check Point-in-Time Recovery (PITR)](/images/5-Workshop/5.4-S3-onprem/check_pirt1.png)

   * **DynamoDB Streams:** `ENABLED (NEW_AND_OLD_IMAGES)`.

![Check DynamoDB Streams Status](/images/5-Workshop/5.4-S3-onprem/check_dynamo_stream2.png)
